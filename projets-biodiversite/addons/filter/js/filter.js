const filter = (function () {
    ...
    for (var [layerId, params] of _layersFiltersParams) {
      ...
      if (mvLayer && oLayer) {
        ...
        if (features.length) {
          ...
          let featuresOnMap = features.length
          document.querySelector('#advancedFilter #nbFeaturesMap').textContent = featuresOnMap;
  ...
  var _filterFeatures = function (layerId) {
    ...
    _setStyle();
    let featuresOnMap = newVisibleFeatures.length
    document.querySelector('#advancedFilter #nbFeaturesMap').textContent = featuresOnMap;
  };
